...
export default function Button({ loading, ...props }: ButtonProps) {
    return (
        <MaterialButton
            ...
            color="primary"
            startIcon={ loading ? (
                <svg aria-hidden="true" className="mr-2 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-gray-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
