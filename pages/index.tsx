        ...
        <div className="w-full">
            ...
            <table className="min-w-full border border-dim-gray">
              ...
              <tbody className="divide-y divide-gray-200 bg-transparent border-none">
                {guesses?.slice(0, 8).map((guess: any) => (
                  <tr key={guess.id} className="bg-alt-gray flex justify-between w-full divide-x divide-dim-gray">
          ...
          <div className="w-full flex justify-center py-4">
            <Link href="/transparency">
              <a className='px-2 py-1 text-gray-300 hover:text-gray-200 border border-dim-gray hover:border-gray-500 hover:shadow rounded'>TRANSPARENCY</a>
            </Link>
          </div>
        </div>
      </main>
